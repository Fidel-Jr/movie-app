...
@section('content')
    <div class="container mt-4">
        <div class="row mb-5">
            <div class="col">
                <div class="flex-none">
                    <img src="{{ 'https://image.tmdb.org/t/p/w300/'.$tvShow['poster_path'] }}" alt="">
                </div>
                
            </div>
            <div class="col-8">
                <h2 class="text-white">{{ $tvShow['name'] }}</h2>
                <div>
                    <span class="ml-1 text-white">{{ $tvShow['vote_average'] }}</span>
                    <span class="mx-2 text-white">|</span>
                    <span class="text-white">{{ $tvShow['first_air_date'] }}</span>
                    <span class="mx-2 text-white">|</span>
                ...
                @if(count($tvShow['videos']['results']) > 0)
                    <div class="mt-5">
                        <a href="https://youtube.com/watch?v={{ $tvShow['videos']['results'][0]['key'] }}" class="btn text-white font-semibold" style="background-color: orangered;">
                            Play Trailer
                        </a>
                    </div>
                @endif
